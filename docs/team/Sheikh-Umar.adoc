...
** Project management:
*** Managed the collation of code of my team for releases `v1.5rc` - `v1.5` (2 releases) on GitHub (Pull request https://github.com/CS2103JAN2018-F11-B1/main/pull/232[#232])
