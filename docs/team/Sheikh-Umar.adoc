...
This application allows salespeople to organize their Leads, Contacts, and Accounts that suits their liking, as well as address problems that are symptomatic in the sales industry,
...
** Justification: Current CRM applications fail to detect duplicates Leads and Contacts. As a result, these CRM applications may store a Lead or Contact numerous times, hence resulting in redundant data. Furthermore, these CRM applications may not be able to display Leads and Contacts separately.
Hence, this enhancement tackles these issues so that the user will have a more pleasant experience with managing his/her Leads and Contacts.
...
include::../DeveloperGuide.adoc[tag=addparentcompanytag]

include::../DeveloperGuide.adoc[tag=findbyphonenumberandemailaddress]

include::../DeveloperGuide.adoc[tag=displaylistusecase]

include::../DeveloperGuide.adoc[tag=addparentcompanytagusecase]

include::../DeveloperGuide.adoc[tag=findphonenumberandemailaddressusecase]

include::../DeveloperGuide.adoc[tag=testingfordisplaycommand]

include::../DeveloperGuide.adoc[tag=testingforduplicatedetection]

include::../DeveloperGuide.adoc[tag=testingforexecutingaliascommands]
