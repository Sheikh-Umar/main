...
such as identifying duplicates, and converting Leads to Contacts.

== Summary of contributions

* *Major enhancement*: Added the ability to retrieve a desired list of non-duplicate data.
** What it does: Informs the user if a Lead to be added in is already in the CRM Boook either as a Lead or a Contact, and allows the user to retrieve a list of either Leads or Contacts.
** Justification: Salespeople oftern face the issue of duplicate data as the CRM applications that they are using does not detect duplicates. Furthermore, the CRM application that they are using may not be able to display Leads and Contacts separately.
