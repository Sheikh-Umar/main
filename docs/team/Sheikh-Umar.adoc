...
** Justification: Salespeople often face the issue of duplicate data as current CRM applications are unable to detect duplicates. As a result, these CRM applications store duplicate Leads and Contacts. Furthermore, the CRM application that they are using may not be able to display Leads and Contacts separately.
Hence, this enhancement tackles these issues so that the user will have a more pleasant experience with a CRM application.
