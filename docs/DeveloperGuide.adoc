...
Umar: +
**Major feature** : Added smart duplicate detection and display list of Leads and Contacts
...
* 2a. CRM Book is unable to find Leads and Contacts that matches with the keywords.
