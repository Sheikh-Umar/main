...
=== Alias Commands feature [Currently for add, list, clear, and edit]
...
* identifying different ways that a lead can be a duplicate. +
* In the sales industry, the same lead may be stored in the CRM application in different forms.
...
Other examples of duplicate detection include rejecting a lead as he/she has the same
phone number as a lead/contact in the CRM application.
...
|`* * *` |salesperson |identify a duplicate|not have redundant data in my CRM
...
|`* *` |salesperson |sort my Leads and Contacts list based on importance|know who my priority Leads and Contacts are
