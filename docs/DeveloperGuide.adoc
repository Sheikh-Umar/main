...
Hence, every Lead and Contact will have an additional tag named after the parent company of their current companies.
The following action diagram illustrates how this will be implemented:

image::AddParentCompanyTag.png[width="800"]
