...
=== Use case: User seeks a list of all Leads in the CRM

*MSS*

1. User enters command for a list of Leads.
2. CRM retrieves the list Leads.
3. User sees the list of Leads.
