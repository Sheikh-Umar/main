...
3.  CRM sorts all persons and lists them.
+
Use case ends.
...
=== Use case: User seeks a list of either Leads or Contacts in the CRM

*MSS*

1. User enters command for a list of either Leads or Contacts.
2. CRM retrieves the list of either Leads or Contacts.
3. User sees the list of either Leads or Contacts.

*Extensions*

[none]
* 1a. User enters keyword that is neither Lead nor Contact.
