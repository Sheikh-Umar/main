...
2. CRM Book executes the add command
3. User is notified on whether CRM has added or rejected the Lead
+
Use case ends.
...
** 2a1. CRM Book displays message that a duplicate is detected and rejects Lead.
+
Use case ends.

* 2b. Lead entered does not have a phone number or email address stored earlier.
** 2b1. CRM Book adds the Lead.
** 2b2. CRM Book displays message that the Lead has been added.
+
Use case ends.
...
2. CRM retrieves the list of either Leads or Contacts.
3. User sees the desired list.
...
** 2a1. CRM Book displays message that the desired list is empty.
+
Use case ends.
