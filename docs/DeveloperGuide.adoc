...
=== Finding a Lead or Contact based on phone numbers and email addresses feature
==== Current Implementation
The CRM Book currently searches for a Lead or Contact based on their name.

The feature is implemented by editing the Find Command to search for phone numbers and email addresses +
...
the CRM Book will display the Lead/Contact that matches the keywords entered.
If not, the CRM Book will display zero Leads/Contacts found.
...
Umar: +
**Major feature** : Displaying list of non-duplicate Leads and Contacts
...
=== Use case: User enters phone number and/or email address to find

*MSS*

1. User enters keywords (phone number and/or email addresses) for find command.
2. CRM searches for Leads and Contacts that match the keywords.
3. User sees the Leads and Contacts that match the keywords
...
* 2a. CRM Books is unable to find Lead/Contact that matches keyword.

** 3a. User sees zero Leads and Contacts found.
+
Use case ends.
// end:displaylistusecase[]
